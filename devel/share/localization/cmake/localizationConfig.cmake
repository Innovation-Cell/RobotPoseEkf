...
if("TRUE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/rishabh/localization/src/localization)
  set(localization_DEVEL_PREFIX /home/rishabh/localization/devel)
  ...
  set(localization_INSTALL_PREFIX /home/rishabh/localization/install)
...
if(NOT "/home/rishabh/localization/devel/include;/home/rishabh/localization/src/localization/include" STREQUAL "")
  set(localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/rishabh/localization/devel/include;/home/rishabh/localization/src/localization/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'rishabh <rishabh@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rishabh/localization/src/localization/${idir}'.  Ask the maintainer 'rishabh <rishabh@todo.todo>' to fix it.")
    endif()
    _list_append_unique(localization_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/opt/ros/hydro/lib/libgeoconv.so;/opt/ros/hydro/lib/libtf.so;/opt/ros/hydro/lib/libtf2_ros.so;/opt/ros/hydro/lib/libactionlib.so;/opt/ros/hydro/lib/libmessage_filters.so;/opt/ros/hydro/lib/libtf2.so;/opt/ros/hydro/lib/libroscpp.so;/usr/lib/libboost_signals-mt.so;/usr/lib/libboost_filesystem-mt.so;/opt/ros/hydro/lib/librosconsole.so;/opt/ros/hydro/lib/librosconsole_log4cxx.so;/opt/ros/hydro/lib/librosconsole_backend_interface.so;/usr/lib/liblog4cxx.so;/usr/lib/libboost_regex-mt.so;/opt/ros/hydro/lib/libroscpp_serialization.so;/opt/ros/hydro/lib/librostime.so;/usr/lib/libboost_date_time-mt.so;/usr/lib/libboost_system-mt.so;/usr/lib/libboost_thread-mt.so;/usr/lib/x86_64-linux-gnu/libpthread.so;/opt/ros/hydro/lib/libxmlrpcpp.so;/opt/ros/hydro/lib/libcpp_common.so;/opt/ros/hydro/lib/libconsole_bridge.so;Libraries/vn100.c;Libraries/vn200.c;Libraries/vncp_services.c;Libraries/RoboteqDevice.cpp")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rishabh/localization/devel/lib;/home/rishabh/localization/devel/lib;/home/rishabh/catkin_new/devel/lib;/opt/ros/hydro/lib)
...
set(depends "geometry_msgs;geographic_msgs;geodesy;roscpp;sensor_msgs;std_msgs;tf;message_runtime;nav_msgs")
